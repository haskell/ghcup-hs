...
installGhcCheckList =
  ...
  : mapSecond (InstallGHC . mkInstallOptions)
    ...
    , ("install ghc prerelease", ToolTag Prerelease)
...
installCabalCheckList =
  ...
  : mapSecond (InstallCabal . mkInstallOptions')
    ...
    , ("install cabal prerelease", ToolTag Prerelease)
...
installHlsCheckList =
  ...
  : mapSecond (InstallHLS . mkInstallOptions')
    ...
    , ("install hls prerelease", ToolTag Prerelease)
...
installStackCheckList =
  ...
  : mapSecond (InstallStack . mkInstallOptions')
    ...
    , ("install stack prerelease", ToolTag Prerelease)
