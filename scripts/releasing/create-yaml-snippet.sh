...
cat <<EOF > /dev/stdout
  GHCup:
    toolDetails:
      ...
      toolRepository: "https://github.com/haskell/ghcup-hs"
      toolDescription: "The standard Haskell installer"
      toolAuthor: "Julian Ospald"
      toolMaintainer: "Julian Ospald"
      toolContact: "hasufell@posteo.de"
      toolLicense: "LGPL-3.0"
    toolVersions:
      ${RELEASE}:
        viTags:
        - Recommended
